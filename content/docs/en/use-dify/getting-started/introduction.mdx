...
<CardGroup cols={3}>
  <Card title="Quick Start" icon="lucide:play" href="/en/use-dify/getting-started/quick-start">
    Start shipping powerful apps in minutes
  </Card>
  <Card title="Concepts" icon="lucide:highlighter" href="/en/use-dify/getting-started/key-concepts">
    Core Dify building blocks explained
  </Card>
  <Card title="Self Host" icon="lucide:arrow-down-to-line" href="/en/self-host/quick-start/docker-compose">
    Deploy Dify on your own laptop / server
  </Card>
  <Card title="Forum" icon="lucide:message-square" href="https://forum.dify.ai">
    Trade notes with the community
  </Card>
  <Card title="Changelog" icon="lucide:bell" href="https://github.com/langgenius/dify/releases">
    What's changed over past releases
  </Card>
  <Card title="Tutorials" icon="lucide:lightbulb" href="/en/use-dify/tutorials/customer-service-bot">

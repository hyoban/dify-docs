...
<Frame caption="在 LangSmith 内创建项目">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/zh_CN/guides/monitoring/integrate-external-ops-tools/58e20105fcc0771ca2431e8e5dcc42d3.png" alt="LangSmith 创建项目界面" />
</Frame>

创建完成之后在 Projects 内可以查看该项目。

<Frame caption="在 LangSmith 内查看已创建项目">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/zh_CN/guides/monitoring/integrate-external-ops-tools/642c0ff7edfdfe77fba43aa22cc3fa71.png" alt="LangSmith 项目列表界面" />
</Frame>
...
<Frame caption="项目设置">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/zh_CN/guides/monitoring/integrate-external-ops-tools/c49a1fc769215193928ff0d880422f89.png" alt="LangSmith 项目设置界面" />
</Frame>

点击 **Create API Key**，创建一个项目凭据。

<Frame caption="创建一个项目 API Key">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/zh_CN/guides/monitoring/integrate-external-ops-tools/7082286b0d12af4bc0c84d9a3acf8b1b.png" alt="LangSmith 创建 API Key 界面" />
</Frame>

选择 **Personal Access Token** ，用于后续的 API 身份校验。

<Frame caption="创建一个 API Key">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/zh_CN/guides/monitoring/integrate-external-ops-tools/75a69bd4dd02f0ffc0313589ae12fb36.png" alt="LangSmith 选择 API Key 类型界面" />
</Frame>

将创建的 API key 复制保存。

<Frame caption="复制 API Key">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/zh_CN/guides/monitoring/integrate-external-ops-tools/723e96a13e8f722d6df714b11ffd0bb1.png" alt="LangSmith API Key 复制界面" />
</Frame>
...
<Frame caption="配置 LangSmith">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/zh_CN/guides/monitoring/integrate-external-ops-tools/b6578e410979cdb9da901aedc94a444d.png" alt="Dify 配置 LangSmith 入口界面" />
</Frame>

点击配置后，将在 LangSmith 内创建的 **API Key** 和**项目名**粘贴到配置内并保存。

<Frame caption="配置 LangSmith">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/zh_CN/guides/monitoring/integrate-external-ops-tools/27173b2503ca7241b084f7cbd17cdb4c.png" alt="Dify 配置 LangSmith 详情界面" />
</Frame>
...
<Frame caption="查看配置状态">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/zh_CN/guides/monitoring/integrate-external-ops-tools/a4e9df6427c7914e1eef6af78d71f408.png" alt="Dify LangSmith 配置状态界面" />
</Frame>
...
<Frame caption="在 Dify 内调试应用">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/zh_CN/guides/monitoring/integrate-external-ops-tools/a0e7b21d56ecf9313f1bd48913f0a74b.png" alt="Dify 应用调试界面" />
</Frame>

<Frame caption="在 LangSmith 内查看应用数据">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/zh_CN/guides/monitoring/integrate-external-ops-tools/2833b2ffa20927b5328e9624b065beea.png" alt="LangSmith 应用数据监测界面1" />
</Frame>

<Frame caption="在 LangSmith 内查看应用数据">
  <img src="https://assets-docs.dify.ai/dify-enterprise-mintlify/zh_CN/guides/monitoring/integrate-external-ops-tools/c40e522f1ffe9fc50411dd7feaf937ed.png" alt="LangSmith 应用数据监测界面2" />
</Frame>

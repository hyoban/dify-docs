...
在扩展模块能力之前，你需要准备一个 API 和用于鉴权的 API Key。
...
此 API 端点即可公网访问。至此，我们即可在 Dify 配置该 API 端点进行本地调试代码，配置步骤请参考 [外部数据工具](/zh/use-dify/workspace/api-extension/external-data-tool-api-extension)。
